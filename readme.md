...
4ba. a **ratings** collection for star ratings feedback,
4bb. a **flags** collection for problem reports,
4bc. a **shares** collection for shareable links,
4bd. and potentially others like an **analytics** collection in the future (right now we log analytics to a file as mentioned, but we     could move it to DB if it grows). 
